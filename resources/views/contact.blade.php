                ...
                <form action="{{ route('contact.submit') }}" enctype="multipart/form-data" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="subject" name="subject"
                            class="w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-hotel-gold focus:border-transparent transition"
                            required>
                             @error('subject') border-red-300 @else border-gray-300 @enderror
                        ...
                        {{-- <div class="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                            ...
                            <div class="flex flex-col sm:flex-row gap-2">
                                <div class="relative flex-grow">
                                    ...
                                    <input type="text" id="start-location" placeholder="Enter your location"
                                        class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-hotel-gold focus:border-transparent transition">
                                </div>
                                <button id="get-directions-btn"
                                    class="bg-hotel-navy text-white py-2 px-4 rounded-lg hover:bg-blue-900 transition flex items-center justify-center">
                        ...
                        <div id="directions-section" class="hidden mb-6">
                            <div class="flex justify-between items-center mb-3">
                                <h4 class="font-semibold text-hotel-navy flex items-center">
                                    <i class="fas fa-map-signs text-hotel-gold mr-2"></i>Directions to VillaVeh
                                    GameView
                                </h4>
                                <button onclick="document.getElementById('directions-section').classList.add('hidden')"
                                    class="text-gray-500 hover:text-gray-700">
                                    <i class="fas fa-times"></i>
                                </button>
                            </div>
                            <div id="directions-panel"
                                class="directions-panel p-3 border border-gray-200 rounded-lg bg-gray-50"></div>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    <div class="flex justify-between items-center py-1 border-b border-gray-100">
                                        ...
                                        <span
                                            class="font-medium bg-green-100 text-green-800 text-xs px-2 py-1 rounded">24/7</span>
                                    </div>
