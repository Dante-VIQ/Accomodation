        ...
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <nav>
                <ul class="flex space-x-8">
                    ...
                    <li><a href="#" class="font-medium text-gold border-b-2 border-gold pb-1">Reservations</a></li>
        ...
        <section class="hero-bg text-white py-16">
            <div class="container mx-auto px-6">
                <div class="max-w-4xl mx-auto text-center">
                    ...
                    <p class="text-xl mb-8 max-w-2xl mx-auto">Experience unparalleled luxury at Luxe Heritage Hotel. Complete the form below to secure your reservation with us.</p>
                    <div class="flex justify-center space-x-4 mb-12">
                        <div class="step-indicator active w-10 h-10 rounded-full flex items-center justify-center font-bold">1</div>
                        <div class="step-indicator w-10 h-10 rounded-full flex items-center justify-center font-bold bg-white text-luxe-gray">2</div>
                        <div class="step-indicator w-10 h-10 rounded-full flex items-center justify-center font-bold bg-white text-luxe-gray">3</div>
                        <div class="step-indicator w-10 h-10 rounded-full flex items-center justify-center font-bold bg-white text-luxe-gray">4</div>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div class="lg:col-span-2">
                        <div class="form-section rounded-2xl shadow-2xl p-8 md:p-10">
                            ...
                            <p class="text-gray-600 mb-8">Please provide your information to complete the reservation. All fields marked with * are required.</p>
                            
                            <form id="bookingForm" class="space-y-8">
                                <!-- Guest Information -->
                                <div>
                                    <h4 class="text-xl font-semibold text-luxe-blue mb-6 pb-2 border-b border-gold-light">Guest Information</h4>
                                ...
                                <!-- Stay Dates -->
                                <div>
                                    <h4 class="text-xl font-semibold text-luxe-blue mb-6 pb-2 border-b border-gold-light">Stay Dates</h4>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                ...
                                <!-- Room Selection -->
                                <div>
                                    <h4 class="text-xl font-semibold text-luxe-blue mb-6 pb-2 border-b border-gold-light">Select Your Accommodation</h4>
                                    <div class="room-selection grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                        <!-- Room options will be dynamically populated -->
                                    </div>
                                    
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Room Type (if not selected above)</label>
                                        <select name="room_id"
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold focus:border-gold transition">
                                ...
                                <!-- Payment Information -->
                                <div>
                                    <h4 class="text-xl font-semibold text-luxe-blue mb-6 pb-2 border-b border-gold-light">Payment Details</h4>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-2">Billing Address (Optional)</label>
                                ...
                                <div class="pt-6 border-t border-gray-200">
                                    <div class="flex items-start mb-8">
                                        ...
                                        <label for="terms" class="text-sm text-gray-700">
                                            I agree to the <a href="#" class="text-gold font-medium hover:underline">Terms & Conditions</a> and <a href="#" class="text-gold font-medium hover:underline">Cancellation Policy</a> of Luxe Heritage Hotel. I understand that my credit card will be charged a deposit equal to one night's stay.
                                        </label>
                                    </div>
                                    ...
                                    <p class="text-center text-gray-500 text-sm mt-4">
                                        <i class="fas fa-lock text-gold mr-1"></i> Your information is secured with 256-bit SSL encryption
                                    </p>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="bg-luxe-blue text-white rounded-2xl shadow-xl p-8">
                            ...
                            <div class="mt-8 pt-6 border-t border-gold-light">
                                <p class="text-gold-light">
                                    ...
                                    <a href="tel:+18001234567" class="font-bold hover:text-white transition">+1 (800) 123-4567</a>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.room-card').forEach(card => {
                card.addEventListener('click', function() {
                    ...
                    document.querySelectorAll('.room-card').forEach(c => {
                        ...
                        c.querySelector('.select-room-btn').classList.remove('bg-gold', 'text-white');
                        c.querySelector('.select-room-btn').classList.add('border', 'border-gold', 'text-gold');
                    });
                    
                    // Add selected class to clicked card
                    this.classList.add('selected');
                    this.querySelector('.select-room-btn').textContent = 'Selected';
                    this.querySelector('.select-room-btn').classList.remove('border', 'border-gold', 'text-gold');
            ...
            bookingForm.addEventListener('submit', function(e) {
                ...
                setTimeout(() => {
                    ...
                    alert('Thank you! Your reservation has been successfully submitted. A confirmation email will be sent shortly.');
                    ...
                    document.querySelectorAll('.room-card').forEach(card => {
                        ...
                        card.querySelector('.select-room-btn').classList.remove('bg-gold', 'text-white');
                        card.querySelector('.select-room-btn').classList.add('border', 'border-gold', 'text-gold');
                    });
                    updateSummary();
                }, 2000);
            });
