        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div class="flex items-start space-x-4">
                <div class="w-14 h-14 rounded-full bg-pink-400 flex items-center justify-center text-white">
                    <!-- Coffee Icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-9 h-9 font-semibold">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9h7.5M9 12h6m-8.25 3h10.5m-3-6.75a3 3 0 013-3h.75a3 3 0 110 6h-.75a3 3 0 01-3-3zM3.75 7.5h.008v.008H3.75V7.5zm0 3h.008v.008H3.75V10.5zm0 3h.008v.008H3.75V13.5z"/>
                    </svg>
                </div>
                <div>
            ...
            <div class="flex items-start space-x-4">
                <div class="w-14 h-14 rounded-full bg-pink-400 flex items-center justify-center text-white">
                    <!-- Shower Icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-9 h-9 font-semibold">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 4.5a6 6 0 1112 0V8m-6 8.25v.008h.008v-.008H9zm0 3v.008h.008v-.008H9zm3-3v.008h.008v-.008H12zm0 3v.008h.008v-.008H12zm3-3v.008h.008v-.008H15zm0 3v.008h.008v-.008H15z" />
                    </svg>
                </div>
                <div>
            ...
            <div class="flex items-start space-x-4">
                <div class="w-14 h-14 rounded-full bg-pink-400 flex items-center justify-center text-white">
                    <!-- Laundry Icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-9 h-9 font-semibold">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25m10.5-2.25V5.25M3 7.5h18M4.5 7.5V21h15V7.5M9 12a3 3 0 116 0 3 3 0 01-6 0z" />
                    </svg>
                </div>
                <div>
            ...
            <div class="flex items-start space-x-4">
                <div class="w-14 h-14 rounded-full bg-pink-400 flex items-center justify-center text-white">
                    <!-- AC Icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-9 h-9 font-semibold">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 7.5h16.5m-16.5 0v6.75A3.75 3.75 0 007.5 18h9a3.75 3.75 0 003.75-3.75V7.5m-16.5 0A3.75 3.75 0 017.5 3.75h9A3.75 3.75 0 0120.25 7.5m-5.25 6H9m0 3h6" />
                    </svg>
                </div>
                <div>
            ...
            <div class="flex items-start space-x-4">
                <div class="w-14 h-14 rounded-full bg-pink-400 flex items-center justify-center text-white">
                    <!-- Wifi Icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-9 h-9 font-semibold">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M8.288 15.712a3 3 0 014.424 0M6.17 13.582a6 6 0 018.66 0M4.05 11.45a9 9 0 0112.9 0M12 18.75h.008v.008H12v-.008z"/>
                    </svg>
                </div>
                <div>
            ...
            <div class="flex items-start space-x-4">
                <div class="w-14 h-14 rounded-full bg-pink-400 flex items-center justify-center text-white">
                    <!-- Kitchen Icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-9 h-9 font-semibold">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v18m10.5-18v18M3 7.5h18M3 12h18M3 16.5h18" />
                    </svg>
                </div>
                <div>
